class Scheduler{
    ...
    schedule(){
        //creating an empty process for when the cpu is idle
        ...
        while ((!this._unreceived_jobs.isEmpty() || !this._schedule_queue.isEmpty())){
            ...
            //add the processes to the schedule queue at their correct arrival times
            ...
            //maintaining an array to store processes that will be in the ready queue at each cpu burst time
            ...
            //execute the process with the lowest remaining time
    ...
    calcAvgTurnaroundTime(){
        ...
        return Math.round(total_turnaround_time * 100/total_no_of_processes) / 100;
    }
    ...
    calcAvgWaitingTime(){
        ...
        return Math.round(total_waiting_time * 100/total_no_of_processes) / 100;
    }
